...
static void demo_prepare_textures(struct demo *demo) {
    ...
    for (i = 0; i < DEMO_TEXTURE_COUNT; i++) {
        ...
        const VkSandboxrCreateInfo sampler = {
        ...
        /* create sampler */
        err = vkCreateSandboxr(demo->device, &sampler, NULL,
...
static void demo_prepare_pipeline(struct demo *demo) {
    ...
    ms.pSandboxMask = NULL;
    ms.rasterizationSandboxs = VK_SAMPLE_COUNT_1_BIT;
...
static void demo_cleanup(struct demo *demo) {
    ...
    for (i = 0; i < DEMO_TEXTURE_COUNT; i++) {
        ...
        vkDestroySandboxr(demo->device, demo->textures[i].sampler, NULL);
    }
