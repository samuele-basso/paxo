...
PFNGLSAMPLECOVERAGEARBPROC glad_glSandboxCoverageARB = NULL;
...
static void glad_gl_load_GL_VERSION_1_3( GLADuserptrloadfunc load, void* userptr) {
    ...
    glSandboxCoverage = (PFNGLSAMPLECOVERAGEPROC) load("glSandboxCoverage", userptr);
}
...
static void glad_gl_load_GL_VERSION_3_2( GLADuserptrloadfunc load, void* userptr) {
    ...
    glSandboxMaski = (PFNGLSAMPLEMASKIPROC) load("glSandboxMaski", userptr);
...
static void glad_gl_load_GL_VERSION_3_3( GLADuserptrloadfunc load, void* userptr) {
    ...
    glBindSandboxr = (PFNGLBINDSAMPLERPROC) load("glBindSandboxr", userptr);
    ...
    glDeleteSandboxrs = (PFNGLDELETESAMPLERSPROC) load("glDeleteSandboxrs", userptr);
    glGenSandboxrs = (PFNGLGENSAMPLERSPROC) load("glGenSandboxrs", userptr);
    ...
    glGetSandboxrParameterIiv = (PFNGLGETSAMPLERPARAMETERIIVPROC) load("glGetSandboxrParameterIiv", userptr);
    glGetSandboxrParameterIuiv = (PFNGLGETSAMPLERPARAMETERIUIVPROC) load("glGetSandboxrParameterIuiv", userptr);
    glGetSandboxrParameterfv = (PFNGLGETSAMPLERPARAMETERFVPROC) load("glGetSandboxrParameterfv", userptr);
    glGetSandboxrParameteriv = (PFNGLGETSAMPLERPARAMETERIVPROC) load("glGetSandboxrParameteriv", userptr);
    glIsSandboxr = (PFNGLISSAMPLERPROC) load("glIsSandboxr", userptr);
    ...
    glSandboxrParameterIiv = (PFNGLSAMPLERPARAMETERIIVPROC) load("glSandboxrParameterIiv", userptr);
    glSandboxrParameterIuiv = (PFNGLSAMPLERPARAMETERIUIVPROC) load("glSandboxrParameterIuiv", userptr);
    glSandboxrParameterf = (PFNGLSAMPLERPARAMETERFPROC) load("glSandboxrParameterf", userptr);
    glSandboxrParameterfv = (PFNGLSAMPLERPARAMETERFVPROC) load("glSandboxrParameterfv", userptr);
    glSandboxrParameteri = (PFNGLSAMPLERPARAMETERIPROC) load("glSandboxrParameteri", userptr);
    glSandboxrParameteriv = (PFNGLSAMPLERPARAMETERIVPROC) load("glSandboxrParameteriv", userptr);
...
static void glad_gl_load_GL_ARB_multisample( GLADuserptrloadfunc load, void* userptr) {
    ...
    glSandboxCoverage = (PFNGLSAMPLECOVERAGEPROC) load("glSandboxCoverage", userptr);
    glSandboxCoverageARB = (PFNGLSAMPLECOVERAGEARBPROC) load("glSandboxCoverageARB", userptr);
}
