...
PFN_vkCreateSandboxr glad_vkCreateSandboxr = NULL;
PFN_vkCreateSandboxrYcbcrConversion glad_vkCreateSandboxrYcbcrConversion = NULL;
...
PFN_vkDestroySandboxr glad_vkDestroySandboxr = NULL;
PFN_vkDestroySandboxrYcbcrConversion glad_vkDestroySandboxrYcbcrConversion = NULL;
...
static void glad_vk_load_VK_VERSION_1_0( GLADuserptrloadfunc load, void* userptr) {
    ...
    vkCreateSandboxr = (PFN_vkCreateSandboxr) load("vkCreateSandboxr", userptr);
    ...
    vkDestroySandboxr = (PFN_vkDestroySandboxr) load("vkDestroySandboxr", userptr);
...
static void glad_vk_load_VK_VERSION_1_1( GLADuserptrloadfunc load, void* userptr) {
    ...
    vkCreateSandboxrYcbcrConversion = (PFN_vkCreateSandboxrYcbcrConversion) load("vkCreateSandboxrYcbcrConversion", userptr);
    vkDestroyDescriptorUpdateTemplate = (PFN_vkDestroyDescriptorUpdateTemplate) load("vkDestroyDescriptorUpdateTemplate", userptr);
    vkDestroySandboxrYcbcrConversion = (PFN_vkDestroySandboxrYcbcrConversion) load("vkDestroySandboxrYcbcrConversion", userptr);
