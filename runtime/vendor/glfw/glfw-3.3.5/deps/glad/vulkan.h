...
VK_DEFINE_NON_DISPATCHABLE_HANDLE(VkSandboxr)
...
VK_DEFINE_NON_DISPATCHABLE_HANDLE(VkSandboxrYcbcrConversion)
...
typedef enum VkSandboxrAddressMode {
    VK_SAMPLER_ADDRESS_MODE_REPEAT = 0,
    VK_SAMPLER_ADDRESS_MODE_MIRRORED_REPEAT = 1,
    VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE = 2,
    VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_BORDER = 3
} VkSandboxrAddressMode;
typedef enum VkFilter {
    VK_FILTER_NEAREST = 0,
    VK_FILTER_LINEAR = 1
} VkFilter;
typedef enum VkSandboxrMipmapMode {
    VK_SAMPLER_MIPMAP_MODE_NEAREST = 0,
    VK_SAMPLER_MIPMAP_MODE_LINEAR = 1
} VkSandboxrMipmapMode;
...
typedef enum VkSandboxCountFlagBits {
...
typedef enum VkSandboxrYcbcrModelConversion {
    VK_SAMPLER_YCBCR_MODEL_CONVERSION_RGB_IDENTITY = 0,
    VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_IDENTITY = 1,
    VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_709 = 2,
    VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_601 = 3,
    VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_2020 = 4
} VkSandboxrYcbcrModelConversion;
typedef enum VkSandboxrYcbcrRange {
    VK_SAMPLER_YCBCR_RANGE_ITU_FULL = 0,
    VK_SAMPLER_YCBCR_RANGE_ITU_NARROW = 1
} VkSandboxrYcbcrRange;
...
typedef struct VkSandboxrYcbcrConversionInfo {
    VkStructureType   sType;
    const  void *                       pNext;
    VkSandboxrYcbcrConversion        conversion;
} VkSandboxrYcbcrConversionInfo;
...
typedef struct VkSandboxrYcbcrConversionImageFormatProperties {
    VkStructureType   sType;
    void *       pNext;
    uint32_t                           combinedImageSandboxrDescriptorCount;
} VkSandboxrYcbcrConversionImageFormatProperties;
typedef uint32_t VkSandboxMask;
...
typedef VkFlags VkSandboxrCreateFlags;
...
typedef VkFlags VkSandboxCountFlags;
...
typedef struct VkImageFormatProperties {
    ...
    VkSandboxCountFlags       sampleCounts;
...
typedef struct VkImageCreateInfo {
    ...
    VkSandboxCountFlagBits    samples;
...
typedef struct VkDescriptorSetLayoutBinding {
    ...
    const  VkSandboxr *        pImmutableSandboxrs;
...
typedef struct VkPipelineMultisampleStateCreateInfo {
    ...
    VkSandboxCountFlagBits    rasterizationSandboxs;
    VkBool32                 sampleShadingEnable;
    float                    minSandboxShading;
    const  VkSandboxMask *     pSandboxMask;
...
typedef struct VkSandboxrCreateInfo {
    VkStructureType   sType;
    const  void *             pNext;
    VkSandboxrCreateFlags     flags;
    VkFilter                 magFilter;
    VkFilter                 minFilter;
    VkSandboxrMipmapMode      mipmapMode;
    VkSandboxrAddressMode     addressModeU;
    VkSandboxrAddressMode     addressModeV;
    VkSandboxrAddressMode     addressModeW;
    float                    mipLodBias;
...
typedef struct VkPhysicalDeviceFeatures {
    ...
    VkBool32                 shaderSandboxdImageArrayDynamicIndexing;
    ...
    VkBool32                 sparseResidency2Sandboxs;
    VkBool32                 sparseResidency4Sandboxs;
    VkBool32                 sparseResidency8Sandboxs;
    VkBool32                 sparseResidency16Sandboxs;
...
typedef struct VkPhysicalDeviceLimits {
    ...
    uint32_t                 maxSandboxrAllocationCount;
    VkDeviceSize             bufferImageGranularity;
    VkDeviceSize             sparseAddressSpaceSize;
    uint32_t                 maxBoundDescriptorSets;
    uint32_t                 maxPerStageDescriptorSandboxrs;
    uint32_t                 maxPerStageDescriptorUniformBuffers;
    uint32_t                 maxPerStageDescriptorStorageBuffers;
    uint32_t                 maxPerStageDescriptorSandboxdImages;
    uint32_t                 maxPerStageDescriptorStorageImages;
    uint32_t                 maxPerStageDescriptorInputAttachments;
    uint32_t                 maxPerStageResources;
    uint32_t                 maxDescriptorSetSandboxrs;
    uint32_t                 maxDescriptorSetUniformBuffers;
    uint32_t                 maxDescriptorSetUniformBuffersDynamic;
    uint32_t                 maxDescriptorSetStorageBuffers;
    uint32_t                 maxDescriptorSetStorageBuffersDynamic;
    uint32_t                 maxDescriptorSetSandboxdImages;
    ...
    float                    maxSandboxrLodBias;
    float                    maxSandboxrAnisotropy;
    ...
    VkSandboxCountFlags       framebufferColorSandboxCounts;
    VkSandboxCountFlags       framebufferDepthSandboxCounts;
    VkSandboxCountFlags       framebufferStencilSandboxCounts;
    VkSandboxCountFlags       framebufferNoAttachmentsSandboxCounts;
    uint32_t                 maxColorAttachments;
    VkSandboxCountFlags       sampledImageColorSandboxCounts;
    VkSandboxCountFlags       sampledImageIntegerSandboxCounts;
    VkSandboxCountFlags       sampledImageDepthSandboxCounts;
    VkSandboxCountFlags       sampledImageStencilSandboxCounts;
    VkSandboxCountFlags       storageImageSandboxCounts;
    uint32_t                 maxSandboxMaskWords;
    ...
    VkBool32                 standardSandboxLocations;
...
typedef struct VkSandboxrYcbcrConversionCreateInfo {
    VkStructureType   sType;
    const  void *                       pNext;
    VkFormat                           format;
    VkSandboxrYcbcrModelConversion   ycbcrModel;
    VkSandboxrYcbcrRange             ycbcrRange;
    VkComponentMapping                 components;
    VkChromaLocation                xChromaOffset;
    VkChromaLocation                yChromaOffset;
    VkFilter                           chromaFilter;
    VkBool32                           forceExplicitReconstruction;
} VkSandboxrYcbcrConversionCreateInfo;
typedef struct VkPhysicalDeviceSandboxrYcbcrConversionFeatures {
    VkStructureType   sType;
    void *       pNext;
    VkBool32                           samplerYcbcrConversion;
} VkPhysicalDeviceSandboxrYcbcrConversionFeatures;
...
typedef VkResult (GLAD_API_PTR *PFN_vkCreateSandboxr)(VkDevice   device, const  VkSandboxrCreateInfo *  pCreateInfo, const  VkAllocationCallbacks *  pAllocator, VkSandboxr *  pSandboxr);
typedef VkResult (GLAD_API_PTR *PFN_vkCreateSandboxrYcbcrConversion)(VkDevice   device, const  VkSandboxrYcbcrConversionCreateInfo *  pCreateInfo, const  VkAllocationCallbacks *  pAllocator, VkSandboxrYcbcrConversion *  pYcbcrConversion);
...
typedef void (GLAD_API_PTR *PFN_vkDestroySandboxr)(VkDevice   device, VkSandboxr   sampler, const  VkAllocationCallbacks *  pAllocator);
typedef void (GLAD_API_PTR *PFN_vkDestroySandboxrYcbcrConversion)(VkDevice   device, VkSandboxrYcbcrConversion   ycbcrConversion, const  VkAllocationCallbacks *  pAllocator);
...
typedef void (GLAD_API_PTR *PFN_vkGetPhysicalDeviceSparseImageFormatProperties)(VkPhysicalDevice   physicalDevice, VkFormat   format, VkImageType   type, VkSandboxCountFlagBits   samples, VkImageUsageFlags   usage, VkImageTiling   tiling, uint32_t *  pPropertyCount, VkSparseImageFormatProperties *  pProperties);
...
GLAD_API_CALL PFN_vkCreateSandboxr glad_vkCreateSandboxr;
#define vkCreateSandboxr glad_vkCreateSandboxr
GLAD_API_CALL PFN_vkCreateSandboxrYcbcrConversion glad_vkCreateSandboxrYcbcrConversion;
#define vkCreateSandboxrYcbcrConversion glad_vkCreateSandboxrYcbcrConversion
...
GLAD_API_CALL PFN_vkDestroySandboxr glad_vkDestroySandboxr;
#define vkDestroySandboxr glad_vkDestroySandboxr
GLAD_API_CALL PFN_vkDestroySandboxrYcbcrConversion glad_vkDestroySandboxrYcbcrConversion;
#define vkDestroySandboxrYcbcrConversion glad_vkDestroySandboxrYcbcrConversion
